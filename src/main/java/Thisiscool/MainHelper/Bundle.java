...
public class Bundle {
    ...
    public static void load(Fi directory, String defaultLocaleCode) {
        directory.walk(fi -> {
            ...
            supported.addUnique(codes.length == 2 ? Locale.forLanguageTag(codes[1]) : Locale.forLanguageTag(codes[1] + "-" + codes[2]));
        });
        ...
        supported.addUnique(Locale.forLanguageTag("router")); 
